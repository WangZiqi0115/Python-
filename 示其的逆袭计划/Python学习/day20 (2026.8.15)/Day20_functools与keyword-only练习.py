...
# ============================================================
square = functools.partial(pow,exp = 2)   # 请在此处编写代码
...
# ============================================================
bin2int = functools.partial(int,base = 2)  # 请在此处编写代码
...
# 注意：你只需写 by_length(a, b) 的函数体；words 列表和 sorted(...) 调用由测试代码提供
# ============================================================
def by_length(a, b):
    # 请在此处编写代码
    return len(a) - len(b)
...
# 提示：用 functools.cmp_to_key
# 注意：你只需写 by_unit(a, b) 的函数体；nums 列表和 sorted(...) 调用由测试代码提供
# ============================================================
def by_unit(a, b):
    # 请在此处编写代码
    return (a % 10) - (b % 10)
